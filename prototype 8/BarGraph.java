...
public class BarGraph extends JPanel {
  ...
  public void paint(Graphics g) {
   ...
   /*   g.drawString("Hello World", 100, 100);*/
      ...
      at.rotate(- Math.PI / 2);
      g2d.setTransform(at);
      g2d.drawString(y_axis_label, -200, 100);
  ...
  public static void main(String[] Args)
  {
   ...
   // frame.add(spacer);
    BarGraph bar1 = new BarGraph("No. of Hours",new double[]{0,20,30,12,23,43,12,10},new String[]{"","Mon","Tue","Wed","Thur","Fri","Sat","Sun"},new Color[] {new Color(0,0,0,0),Color.red, Color.blue, Color.green,Color.LIGHT_GRAY,Color.MAGENTA,Color.DARK_GRAY,Color.orange},"Daily" ) ;
    BarGraph bar2 = new BarGraph("No. of Hours",new double[]{0,10,20,30,50},new String[]{"","Week1","Week2","Week3","Week4"},new Color[] {new Color(0,0,0,0),Color.black, Color.blue, Color.green,Color.LIGHT_GRAY},"Weekly" ) ;
    BarGraph bar3 = new BarGraph("No. of Hours",new double[]{0,10,20,30,50,65,34,76,12,34,54,8,6},new String[]{"","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"},new Color[] {new Color(0,0,0,0),Color.DARK_GRAY, Color.blue, Color.green,Color.LIGHT_GRAY,Color.orange,Color.red,Color.yellow,Color.pink,Color.YELLOW,Color.CYAN,Color.white,Color.WHITE},"Monthly" ) ;

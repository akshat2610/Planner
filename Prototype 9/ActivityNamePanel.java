...
public class ActivityNamePanel extends JPanel{
	...
	*/
	...
	//	UIManager.put("ProgressBar.selectionBackground", color);
	 // UIManager.put("ProgressBar.selectionForeground", new Color(50, 168, 82));
	//	taskProgressBar.setForeground(color);
	//	taskProgressBar.setBackground(color);

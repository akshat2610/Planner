...
public class Model{
  ...
  public Model(){
    try{
      ...
      if (firstRun){
        ...
        dailyWorkload = JOptionPane.showInputDialog("Enter number of hours you want to work per day");
        numDayWorkWeek = JOptionPane.showInputDialog("Enter number of days you want to work per week");
  ...
  */
  public void loadFromDatabase(){
    ...
    */
    ...
    finished = (List<Task>)finishedListInputStream.readObject();
    ...
    activities = (List<Activity>)activitiesListInputStream.readObject();
  ...
  */
  ...
  public static void main(String[] args){
    ...
    List<Task> finished = m.getFinishedTasks();

...
public class ActivityPanel extends JPanel{
	...
	*/
	public ActivityPanel(View parentView, Task task){
		this.parentView = parentView;
		activityNamePanel = new ActivityNamePanel(parentView, task);
		optionsPanel = new OptionsPanel(parentView);
	...
	*/
	public void setParentListPanel(ListPanel parentListPanel){
